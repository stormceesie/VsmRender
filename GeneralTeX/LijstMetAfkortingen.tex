...
\newacronym{USB}{USB}{Universal serial bus}
\newacronym{IPC}{IPC}{Industrial \gls{PC}}
\newacronym{PC}{PC}{Personal Computer}
\newacronym{IO}{IO}{Input/Output}
\newacronym{SAP}{SAP}{System Analysis Program Development. bedrijfsapplicatiesoftware}
\newacronym{ST}{ST}{Structured Text}
\newacronym{TC3}{TC3}{\gls{TwinCAT} 3}
\newacronym{BaseLib}{base library}{De \gls{PLC} base library van Voortman voor algemene objecten}