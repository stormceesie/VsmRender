...
namespace Voortman {
	// Currently moveable with arrows and WASD because mouse movement with middle mouse button forces you to use eventhandlers with GLFW
	void SteelSightCameraMovement::moveInPlaneXZ(GLFWwindow* window, float dt, SteelSightSimulationObject& gameObject) {
		glm::vec3 rotate{ 0 };
		...
		const glm::vec3 upDir{ 0.f, -1.f, 0.1f };
