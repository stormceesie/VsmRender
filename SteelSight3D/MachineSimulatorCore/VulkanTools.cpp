...
#include "VulkanTools.hpp"
 ...
 // iOS & macOS: MachineSimulatorCore::getAssetPath() implemented externally to allow access to Objective-C components
...
#undef STR
		...
		// Wide string is required for MessageBox(...);
		void exitFatal(const std::wstring& message, int32_t exitCode)
		{
#if defined(_WIN32)
			if (!errorModeSilent) {
